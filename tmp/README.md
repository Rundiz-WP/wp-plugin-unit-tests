...
* wordpress.tar.gz This file must contain the WordPress files and folders in it. The file in this repository is just an example. You can download this file from [wordpress.org website](https://wordpress.org/download/releases/) (as .tar.gz) and replace its content in the archive file here.
